...
export const H3Text = 'text-white font-bold text-l'; // styling
// H2 Überschriften: z.B: events, friends, games
export const categoryText = 'text-white font-bold text-xl tracking-widest'; // styling
// H1 Überschriften: z.B: sipster
export const brandingText = 'text-white font-bold text-3xl tracking-widest'; // styling
// Standartabstand zu den oberen Elementen
export const spaceText = 'mt-4 mx-6'; // spacing
